...
This repository is a verification-focused companion to the Traditional Chinese Learn Harness Engineering course. It is not a mirror of the source material.
...
Every verification artifact should eventually trace back to a row in `docs/source-map.md`.
...
4. Confidence / open questions: whether the mapping is grounded enough to build on.
